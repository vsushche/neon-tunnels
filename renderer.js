...
export class Renderer {
    ...
    renderSegmentWires(p1, p2, dim, laserGlow = 0, explosionGlow = 0) {
        ...
        this.ctx.beginPath();
        this.ctx.moveTo(p1.tl_x, p1.tl_y);
        this.ctx.lineTo(p1.tr_x, p1.tr_y);
        this.ctx.lineTo(p1.br_x, p1.br_y);
        this.ctx.lineTo(p1.bl_x, p1.bl_y);
        this.ctx.closePath();
        this.ctx.stroke();
        ...
        this.ctx.moveTo(p1.tr_x, p1.tr_y);
        this.ctx.lineTo(p2.tr_x, p2.tr_y);
        this.ctx.moveTo(p1.bl_x, p1.bl_y);
        this.ctx.lineTo(p2.bl_x, p2.bl_y);
        this.ctx.moveTo(p1.br_x, p1.br_y);
        this.ctx.lineTo(p2.br_x, p2.br_y);
        this.ctx.stroke();
    ...
    renderEnergyMine(x, y, radius, now, dim, seed = 0) {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            ctx.strokeStyle = i === 1 ? `rgba(255, 210, 67, ${0.58 * alpha})` : `rgba(72, 245, 255, ${0.62 * alpha})`;
